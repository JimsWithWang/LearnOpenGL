...
void ShaderWidget::paintGL()
{
    ...
    float greenValue = static_cast<float>(qSin(QDateTime::currentDateTime().toSecsSinceEpoch()) / 2.0 + 0.5);
    int vertexColorLocation = glGetUniformLocation(m_nShaderProgram, "ourColor");
